...
**PDF:** [A7871A PDF](https://legislation.nysenate.gov/pdf/bills/2024/A7871A)
...
S T A T E  O F  N E W  Y O R K
 ...
 DISEASE, RESULTING IN TOTAL OR PARTIAL DISABILITY OR DEATH TO  A  MEMBER
 WHO  OUTSIDE HIS OR HER RETIREMENT SYSTEM MEMBERSHIP IS ALSO A VOLUNTEER
 FIREFIGHTER IN THIS STATE AND HAS BEEN FOR  A  MINIMUM  OF  FIVE  YEARS,
 WHERE SUCH VOLUNTEER FIREFIGHTER SUCCESSFULLY PASSED A PHYSICAL EXAMINA-
 TION  ON  ENTRY  INTO  SERVICE  AS A VOLUNTEER FIREFIGHTER OR SUBSEQUENT
 THERETO, WHICH EXAMINATION FAILED TO REVEAL ANY EVIDENCE OF SUCH  CONDI-
 TION,  SHALL BE PRESUMPTIVE EVIDENCE THAT, UNLESS THE CONTRARY BE PROVEN
 BY COMPETENT EVIDENCE, SUCH DISABILITY OR DEATH OF THE  MEMBER  (A)  WAS
 CAUSED BY THE NATURAL AND PROXIMATE RESULT OF AN ACCIDENT, NOT CAUSED BY
 SUCH  MEMBER'S  OWN  WILLFUL  NEGLIGENCE,  AND  (B)  WAS INCURRED IN THE
 PERFORMANCE AND DISCHARGE OF THE MEMBER'S DUTY.  THE MEMBER SHALL SUBMIT
 DOCUMENTATION VERIFYING THAT THEY MEET THE ELIGIBILITY  REQUIREMENTS  OF
 THIS SECTION.
 ...
 FIGHTER, OR ANY RETIRED VOLUNTEER FIREFIGHTER WHO HAS BEEN  RETIRED  FOR
 TWO  OR LESS YEARS, WHERE SUCH VOLUNTEER FIREFIGHTER SUCCESSFULLY PASSED
 A PHYSICAL EXAMINATION ON ENTRY  INTO  SERVICE  OR  SUBSEQUENT  THERETO,
 WHICH  EXAMINATION  FAILED TO REVEAL ANY EVIDENCE OF SUCH CONDITION, AND
 WHO HAS BEEN A VOLUNTEER FIREFIGHTER IN THIS STATE FOR A MINIMUM OF FIVE
 YEARS, SHALL BE PRESUMPTIVE EVIDENCE THAT SUCH DISABILITY OR  DEATH  (A)
 WAS  CAUSED  BY  THE  NATURAL  AND  PROXIMATE RESULT OF AN ACCIDENT, NOT
 CAUSED BY SUCH FIREFIGHTER'S OWN NEGLIGENCE, AND (B) WAS INCURRED IN THE
