...
**PDF:** [A1722BA PDF](https://legislation.nysenate.gov/pdf/bills/2024/A1722BA)
...
S T A T E  O F  N E W  Y O R K
 ...
 Introduced  by  M.  of  A. ZINERMAN, DINOWITZ, WALKER, SILLITTI, TAYLOR,
  ...
  TAPIA, NOVAKHOV -- read once and referred to the Committee on Election
 ...
 amendment, proposition or question] OF THE FOLLOWING:
  A. A BRIEF DESCRIPTIVE TITLE OF UP TO FIFTEEN WORDS,  WHICH  DESCRIBES
 THE  TOPIC,  GOAL  OR  OUTCOME  OF  THE BALLOT PROPOSAL WRITTEN IN PLAIN
 LANGUAGE;
  B. A SUMMARY OF THE TEXT OF THE BALLOT PROPOSAL OF UP TO THIRTY WORDS,
 WRITTEN IN PLAIN LANGUAGE, THAT DESCRIBES THE CHANGE  IN  POLICY  TO  BE
 ADOPTED AND NOT THE LEGAL MECHANISM; AND
  C.  A  STATEMENT  OF  WHAT  A "YES" OR "NO" VOTE MEANS OF UP TO THIRTY
 WORDS, WRITTEN IN PLAIN LANGUAGE THAT IDENTIFIES THE  PRACTICAL  OUTCOME
 OF EACH ELECTION RESULT AND NOT THE LEGAL MECHANISM. THE BALLOT PROPOSAL
 LANGUAGE MAY CONSIST OF MULTIPLE SENTENCES.
  If  more  than  one  such  amendment, proposition or question is to be
 voted upon at such election, each such amendment, proposition  or  ques-
 tion respectively shall be separately and consecutively numbered.
 ...
 DAYS SUBSEQUENT TO SUCH PUBLICATION.
  B.  THE  STATE  BOARD  OF  ELECTIONS  SHALL REVIEW AND CONSIDER PUBLIC
 COMMENTS BEFORE ADOPTING THE FINAL  FORM  OF  THE  BALLOT  PROPOSAL  AND
 ABSTRACT.  THE  STATE  BOARD  OF  ELECTIONS  SHALL ALSO PUBLISH ON ITS
 WEBSITE THE AUTOMATED READABILITY INDEX  SCORE  CALCULATED  PURSUANT  TO
 SUBDIVISION SIX OF THIS SECTION FOR EACH FORM OF QUESTION AND ABSTRACT.
  C.  THE  SCORE  SHALL  REQUIRE  NO HIGHER THAN AN EIGHTH GRADE READING
 LEVEL (A SCORE OF EIGHT ON THE AUTOMATED READABILITY INDEX), UNLESS  THE
 STATE  BOARD  OF  ELECTIONS  SHALL STATE THE BASIS FOR ITS DETERMINATION
 THAT THE PLAIN LANGUAGE REQUIREMENTS OF THIS SECTION ARE MET.
 ...
 PROPOSAL  AND  ABSTRACT.  THE AUTOMATED READABILITY INDEX SCORE SHALL BE
 ...
 THAT NUMBER BY 0.5;
  ...
  D.  SUBTRACT  21.43 FROM THE RESULT OF PARAGRAPH C OF THIS SUBDIVISION
 AND ROUND TO THE NEAREST WHOLE NUMBER.
  7. NO SPECIFIC AUTOMATED READABILITY INDEX SCORE  SHALL  BE  REQUIRED;
 PROVIDED,  HOWEVER,  THE STATE BOARD OF ELECTIONS SHALL USE BEST EFFORTS
 TO SCORE AT AN EIGHTH GRADE READING LEVEL OR BELOW AND  MEET  THE  DEFI-
 NITION  OF  PLAIN LANGUAGE IN SUBDIVISION FIVE OF THIS SECTION. IN ADDI-
 TION, THE STATE BOARD OF ELECTIONS SHALL EXPEND THEIR BEST  EFFORTS  NOT
 TO  EXCEED THE WORD LIMITS IN SUBDIVISION TWO OF THIS SECTION BUT MAY DO
 SO WHEN PLAIN LANGUAGE CLARITY IS IMPROVED THEREBY.
 ...
 ELECTIONS WHICH MAINTAINS A WEBSITE.
  § 4. Section 4-116 of the election law  is amended by  adding  a  new
