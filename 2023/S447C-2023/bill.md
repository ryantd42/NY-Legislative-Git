...
S T A T E  O F  N E W  Y O R K
 ...
 SECTION SHALL PROHIBIT AN EDUCATION PROGRAM FROM PROVIDING GREATER  THAN
 ONE-THIRD  OF  SUCH TRAINING THROUGH SIMULATION EXPERIENCE, PROVIDED THE
 DEPARTMENT HAS GRANTED APPROVAL TO DO SO PRIOR  TO  JANUARY  FIRST,  TWO
 THOUSAND  TWENTY-THREE.  The department, in its discretion, may issue a
 ...
 LATION. NOTHING IN THIS SECTION SHALL PROHIBIT AN EDUCATION PROGRAM FROM
 PROVIDING GREATER THAN ONE-THIRD OF  SUCH  TRAINING  THROUGH  SIMULATION
 EXPERIENCE,  PROVIDED THE DEPARTMENT HAS GRANTED APPROVAL TO DO SO PRIOR
 TO JANUARY FIRST, TWO THOUSAND TWENTY-THREE.  PROVIDED HOWEVER  NOTHING
 IN  THIS  SECTION SHALL REDUCE THE IN-PERSON OR DIRECT CARE REQUIREMENTS
 ESTABLISHED BY PROGRAMMATIC ACCREDITORS AND CERTIFYING BODIES; or
