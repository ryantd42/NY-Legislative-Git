...
**PDF:** [A2193 PDF](https://legislation.nysenate.gov/pdf/bills/2023/A2193)
...
S T A T E  O F  N E W  Y O R K
 ...
 to  certain  criminal  justice  reform  in the state of New York.  Each
 ...
 when  used  in  connection with that  particular  component, shall  be
 ...
 THOUSAND TWENTY-FIVE AND TWO THOUSAND TWENTY-SIX,  ONE  HUNDRED  MILLION
 ...
 § 510.30 Application for [securing order] RECOGNIZANCE OR BAIL; rules of
  ...
  1. DETERMINATIONS OF APPLICATIONS FOR RECOGNIZANCE OR BAIL  SHALL  NOT
 BE  IN ALL CASES DISCRETIONARY BUT SHALL BE SUBJECT TO RULES, PRESCRIBED
 IN ARTICLE FIVE HUNDRED THIRTY OF THIS TITLE AND OTHER PROVISIONS OF LAW
 ...
 otherwise  provided  by  law,  must  impose the least restrictive] SHALL
 CONSIDER THE kind and degree of control or restriction that is necessary
 to secure the principal's return to court when required. In  determining
 that  matter, the court [must] SHALL, on the basis of available informa-
 tion, consider and take into account [information  about  the  principal
 that is relevant to the principal's return to court, including]:
  [(a) The principal's activities and history;
  (b) If the principal is a defendant, the charges facing the principal;
 ...
 obtain a secured, unsecured, or partially secured bond;
  (g) any violation by the principal of an order of protection issued by
 any court;
  (h)]  (VII)  WHERE  THE  PRINCIPAL  IS  CHARGED WITH A CRIME OR CRIMES
 ...
 FACTOR INDICATING PROBABILITY OF CONVICTION;  OR,  in  the  case  of  an
 application  for [a securing order] BAIL OR RECOGNIZANCE pending appeal,
 the merit or lack of merit of the appeal; AND
 ...
 ing the defendant to the custody of the sheriff where authorized.]
  [3.] 2. Where an appeal by the people has been  taken  from  an  order
 ...
 defendant has substantiated affiliation with a  criminal  enterprise  as
