...
**PDF:** [A3630 PDF](https://legislation.nysenate.gov/pdf/bills/2023/A3630)
...
S T A T E  O F  N E W  Y O R K
 ...
 19-b to read as follows:
  §  19-B.  ANNUAL  REPORTING  REQUIREMENTS.  NOTWITHSTANDING  ANY OTHER
 PROVISIONS OF THE LAW TO THE CONTRARY COMMENCING ON JANUARY  FIRST,  TWO
 THOUSAND  TWENTY-THREE  AND  EACH YEAR THEREAFTER ALL STATE AGENCIES AND
 ALL STATE AND LOCAL AUTHORITIES AS DEFINED BY SECTION TWO OF THE  PUBLIC
 AUTHORITIES  LAW  SHALL  SUBMIT  TO  THE GOVERNOR, THE CHAIR AND RANKING
 MINORITY MEMBER OF THE SENATE FINANCE COMMITTEE AND THE CHAIR AND  RANK-
 ING  MINORITY  MEMBER OF THE ASSEMBLY WAYS AND MEANS COMMITTEE AN ANNUAL
 REPORT. SUCH REPORT SHALL INCLUDE, BUT SHALL  NOT  BE  LIMITED  TO,  THE
 OUTSTANDING  TOTAL  DEBT  FOR EACH ENTITY; TOTAL ANNUAL DEBT SERVICE FOR
 EACH ENTITY; ANNUAL DEBT ISSUANCE FOR EACH ENTITY; AND ANNUAL DEBT TO BE
 RETIRED FOR EACH ENTITY.
