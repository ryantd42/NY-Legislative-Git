# Relates to drivers' license suspensions for traffic fatalities
...
S T A T E  O F  N E W  Y O R K
 ...
 as follows:
  (XVIII)  FOR  A  PERIOD  NO LESS THAN SIXTY DAYS BUT NO LATER THAN THE
 SUCCESSFUL COMPLETION OF THE REQUIREMENTS SET FORTH UNDER THIS  SUBPARA-
 GRAPH  WHERE  THE HOLDER WAS OPERATING A MOTOR VEHICLE AT THE TIME OF AN
 ACCIDENT WHICH RESULTED IN  A  FATALITY.  A  PERSON  WHOSE  LICENSE  WAS
 SUSPENDED  UNDER THIS SUBPARAGRAPH SHALL NOT HAVE THEIR LICENSE RESTORED
 BEFORE THE SUCCESSFUL RECOMPLETION OF ALL REQUIREMENTS UNDER SUBDIVISION
 FOUR OF SECTION FIVE HUNDRED TWO OF THIS ARTICLE FOR SUCH LICENSE  WHICH
 SHALL  NOT  TAKE  PLACE BEFORE THE SIXTIETH DAY AFTER THE ACCIDENT WHICH
