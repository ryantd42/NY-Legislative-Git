...
S T A T E  O F  N E W  Y O R K
 ...
 S. 772  2
  ...
  a. information on the effects of the additional income on the  health,
 stress  levels,  and  mental health of each participant and their house-
 hold;
  b.  information  on the effects of the additional income on the income
 level of each participant, including the alleviation of poverty for  any
 participant experiencing poverty;
  c.  information regarding changes in employment or employment opportu-
 nities as a result of the additional income  for  each  participant  and
 their household;
  d.  socio-demographic  information,  including  but not limited to the
 age, race, ethnicity, education level, family composition, community  of
 residence,  housing  costs,  income  level,  and  government  benefits
 received, of each participant and their household;
  e. data on how the additional income from the program  was  allocated;
 and
  f.  recommendations  on  implementing  future  universal  income pilot
 programs, including a statewide program.
