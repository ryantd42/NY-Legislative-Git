...
S T A T E  O F  N E W  Y O R K
 ...
 ical data that can be made accessible via geographic information systems
 (GIS) mapping  and  ensuring  that  all  datasets  have  an  application
 ...
 data;
  ...
  (e) develop pathways to include  data  derived  from  citizen  science
 efforts.
 ...
 cies.
  4.  The  agencies  and the conveners shall update all data collected
 pursuant to this act at least annually.
