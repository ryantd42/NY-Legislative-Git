...
S T A T E  O F  N E W  Y O R K
 ...
 subdivision 22 to read as follows:
  22.  "PREMIUM  CIGAR."  MEANS  ANY ROLL OF TOBACCO FOR SMOKING THAT IS
 WRAPPED IN WHOLE TOBACCO LEAF;  CONTAINS  A  ONE  HUNDRED  PERCENT  LEAF
 TOBACCO  BINDER;  CONTAINS  AT LEAST FIFTY PERCENT (OF FILLER BY WEIGHT)
 LONG LEAF TOBACCO; IS HANDMADE OR HAND ROLLED; HAS NO FILLER, NONTOBACCO
 TIP OR NONTOBACCO MOUTHPIECE; DOES  NOT  HAVE  A  CHARACTERIZING  FLAVOR
 OTHER  THAN TOBACCO; CONTAINS ONLY TOBACCO, WATER AND VEGETABLE GUM WITH
 NO OTHER INGREDIENTS OR ADDITIVES; AND WEIGHS MORE THAN SIX  POUNDS  PER
 ONE THOUSAND UNITS.
