...
S T A T E  O F  N E W  Y O R K
 ...
 THIS SECTION, "GAS STOVE" MEANS A NATURAL GAS STOVE  OR  RANGE  THAT  IS
 USED  FOR  FOOD  PREPARATION,  WHETHER  IN  A  COMMERCIAL OR RESIDENTIAL
 SETTING, AND PROVIDES AT LEAST ONE OF THE FOLLOWING FUNCTIONS:
  (A) SURFACE COOKING;
  (B) OVEN COOKING; OR
  (C) BROILING.
  2. NO PERSON SHALL SELL, ATTEMPT TO SELL,  OR  OFFER  FOR  SALE  TO  A
 CONSUMER  IN  THIS  STATE  A  GAS STOVE THAT IS MANUFACTURED ON OR AFTER
 JANUARY FIRST, TWO THOUSAND TWENTY-FIVE, UNLESS THE  FOLLOWING  REQUIRE-
 MENTS ARE MET:
  (A)  (I)  A  REMOVABLE  LABEL  AFFIXED TO THE GAS STOVE IN A PROMINENT
 LOCATION BEARS THE FOLLOWING MESSAGE:
  ...
  (II) THE LABEL SHALL BE AFFIXED TO THE GAS STOVE BY A MANUFACTURER  OR
 IMPORTER  IN  A  CONSPICUOUS  LOCATION  SO  THAT  IT IS EASILY READ BY A
 CONSUMER EXAMINING THE PRODUCT, AND MUST BE IN A TYPE  SIZE  NO  SMALLER
 THAN  THE  LARGEST  TYPE SIZE USED FOR OTHER CONSUMER INFORMATION ON THE
 PRODUCT.
 ...
 STOVES  ARE  SOLD  SO  THAT  IT  IS  NOTICEABLE AND EASILY READABLE BY A
 CONSUMER EXAMINING GAS STOVES FOR SALE.
 ...
 TO THE STATE OF NEW YORK FOR A CIVIL PENALTY OF FIVE HUNDRED DOLLARS FOR
 THE  FIRST  VIOLATION AFTER RECEIVING A WARNING AND ONE THOUSAND DOLLARS
 A. 9572  5
 
 FOR ANY SUBSEQUENT VIOLATION IN THE SAME CALENDAR  YEAR.  A  HEARING  OR
