# Relates to the approval of contracts awarded to owners of nuclear powered generating facilities
...
S T A T E  O F  N E W  Y O R K
 ...
 BLY, DO ENACT AS FOLLOWS:
  ...
  Section  1. Section 2879-a of the public authorities law is amended by
 adding a new subdivision 3-a to read as follows:
  3-A. PARAGRAPHS (D), (E) AND (F) OF SUBDIVISION THREE OF THIS  SECTION
 SHALL  NOT  APPLY  TO  ANY  CONTRACT  AWARDED  TO THE OWNER OF A NUCLEAR
 POWERED GENERATING FACILITY OR FACILITIES  FOR  THE  PROVISION  OF  SUCH
 FACILITY OR FACILITIES' ZERO-EMISSIONS ATTRIBUTES OF GENERATED ELECTRIC-
 ITY.
