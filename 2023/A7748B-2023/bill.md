...
S T A T E  O F  N E W  Y O R K
 ...
 VALUE  OF  AN  ELIGIBLE  PROPERTY,  IN A DOLLAR AMOUNT, RESULTING FROM A
 MAJOR OR LOCAL DISASTER, BELOW  WHICH,  AN  ELIGIBLE  PROPERTY  MAY  NOT
 RECEIVE AN ABATEMENT PURSUANT TO THIS SECTION.
 ...
 REPEALED;
  (II)  A  SPECIFICATION  OF THE DATE BY WHICH APPLICATIONS RECEIVED ARE
 VALID, PROVIDED THAT SUCH DATE MAY BE PRIOR TO  THE  EFFECTIVE  DATE  OF
 SUCH LOCAL LAW OR RESOLUTION;
  (III)  A  DEADLINE  FROM THE DATE UPON WHICH A LOCAL OR MAJOR DISASTER
 CAUSED  DAMAGE  TO  AN  ELIGIBLE  PROPERTY,  AFTER  WHICH,  APPLICATIONS
 RECEIVED FOR SUCH MAJOR OR LOCAL DISASTER SHALL BE INVALID; AND
 ...
 ELIGIBLE PROPERTIES DAMAGED BY A LOCAL OR MAJOR DISASTER IF THE OWNER OF
 SUCH ELIGIBLE PROPERTY HAS NOT CONTRIBUTED TO SUCH DAMAGE.
