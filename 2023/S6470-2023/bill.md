# Authorizes conditional adult-use cultivator licensees to sell their own cannabis products and authorizes the office of cannabis management to create a program for licensees to process cannabis into distillate

**Bill ID:** S6470
**Session:** 2023
**Sponsor:** Michelle Hinchey
**Status:** In Senate Committee
**PDF:** [S6470 PDF](https://legislation.nysenate.gov/pdf/bills/2023/S6470)
...
S T A T E  O F  N E W  Y O R K
 ...
 subdivisions 16 and 17 to read as follows:
  16. NOTWITHSTANDING ANY OTHER PROVISION OF THIS SECTION, A CONDITIONAL
 ADULT-USE  CULTIVATOR  LICENSEE SHALL BE AUTHORIZED TO SELL THEIR OWN OR
 ANOTHER CONDITIONAL  ADULT-USE  CULTIVATOR  LICENSEE  HOLDER'S  CANNABIS
 PRODUCTS  DIRECTLY TO CONSUMERS UNTIL NO LATER THAN SEPTEMBER THIRTIETH,
 TWO THOUSAND TWENTY-THREE. SUCH AUTHORITY SHALL ALLOW FOR ON-FARM  SALES
 OF  TESTED,  PACKAGED  AND SEALED PRODUCTS.  THE OFFICE IS AUTHORIZED TO
 ISSUE EMERGENCY REGULATIONS, IF NECESSARY, TO  IMPLEMENT  THIS  SUBDIVI-
 SION.
 ...
 S. 6470  2
  ...
  17. THE OFFICE IS AUTHORIZED TO CREATE A LOAN OR GRANT PROGRAM FOR THE
 PURPOSE  OF  HAVING  ANY  CANNABIS  GROWN  UNDER A CONDITIONAL ADULT-USE
 CULTIVATOR LICENSE PRIOR TO SEPTEMBER THIRTIETH,  TWO  THOUSAND  TWENTY-
 THREE  PROCESSED  INTO  DISTILLATE.  THE  END-PRODUCT OF SUCH PROCESSING
 SHALL BE RETURNED TO THE LICENSEE FOR FUTURE USE.
  § 4. A conditional adult-use cultivator licensee may select to operate
 under  subdivisions  16 and 17 of section 68-c of the cannabis law until
 September 30, 2023.
