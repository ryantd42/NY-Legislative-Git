...
**PDF:** [A1934 PDF](https://legislation.nysenate.gov/pdf/bills/2023/A1934)
...
S T A T E  O F  N E W  Y O R K
 ...
 A. 1934  2
  ...
  (b) the potential  transit  travel  time  reductions,  greenhouse  gas
 reductions,  and  economic  benefits  expected  from  the public transit
 service on the Triboro rail line;
  (c) the locations of potential stations, frequency and span of service
 expected to run daily along the Triboro rail line;
  (d) the operational segments (in phases) to get service started; sche-
 dules  needed  for  co-mingling with freight; expected freight expansion
 and impacts to service; and
  (e) any actions that can be implemented by the Metropolitan  Transpor-
 tation  Authority immediately, a plan of action for such implementation,
 and the estimated cost of such implementation plan.
