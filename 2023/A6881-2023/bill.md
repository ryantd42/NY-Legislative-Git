...
**PDF:** [A6881 PDF](https://legislation.nysenate.gov/pdf/bills/2023/A6881)
...
S T A T E  O F  N E W  Y O R K
 ...
 REGISTERED AS A TRANSIENT WITHIN THIRTY DAYS  FROM  THE  DATE  OF  THEIR
 RELEASE FROM INCARCERATION.
  (II)  AFTER  INITIAL REGISTRATION, HE OR SHE SHALL RE-REGISTER EVERY
 THIRTY DAYS.
  (III)  A  TRANSIENT  SHALL,  UPON  REGISTRATION  AND  REREGISTRATION,
 PROVIDE  CURRENT  INFORMATION  AS  REQUIRED ON THE DIVISION REGISTRATION
 FORMS, AND SHALL ALSO LIST THE PLACES WHERE  HE  OR  SHE  SLEEPS,  EATS,
 WORKS,  FREQUENTS,  AND  ENGAGES  IN  LEISURE ACTIVITIES. IF A TRANSIENT
 CHANGES OR ADDS TO THE PLACES LISTED ON THE FORM DURING  THE  THIRTY-DAY
 PERIOD,  HE OR SHE DOES NOT NEED TO REPORT THE NEW PLACE OR PLACES UNTIL
 THE NEXT REQUIRED REREGISTRATION.
  (IV)  IF A TRANSIENT CONVICTED IN  ANOTHER  JURISDICTION  ENTERS  THE
 STATE,  HE OR SHE SHALL REGISTER WITHIN FIVE WORKING DAYS OF COMING INTO
 THE STATE WITH THE LOCAL LAW ENFORCEMENT AGENCY IN WHICH HE  OR  SHE  IS
 PRESENT OR THE SHERIFF OF THE COUNTY.
  (V)  IF A TRANSIENT IS NOT PHYSICALLY PRESENT IN ANY ONE JURISDICTION
 FOR FIVE CONSECUTIVE WORKING DAYS, HE  OR  SHE  SHALL  REGISTER  IN  THE
 JURISDICTION IN WHICH HE OR SHE IS PHYSICALLY PRESENT ON THE FIFTH WORK-
 ING DAY FOLLOWING RELEASE.
  (VI)  A TRANSIENT WHO MOVES OUT OF STATE SHALL WITHIN FIVE BUSINESS
 DAYS INFORM THE LOCAL LAW ENFORCEMENT AGENCY WHERE HE OR  SHE  IS  PHYS-
 ICALLY PRESENT, IN PERSON, OF HIS OR HER MOVE OUT OF STATE AND OF HIS OR
 HER  PLANNED  DESTINATION, RESIDENCE OR TRANSIENT LOCATION OUT OF STATE,
 AND ANY PLANS HE OR SHE HAS TO RETURN TO THE STATE, IF KNOWN.  THE  LAW
 ENFORCEMENT AGENCY SHALL, WITHIN THREE DAYS AFTER RECEIPT OF THIS INFOR-
 MATION,  FORWARD  A  COPY  OF  THE CHANGE OF LOCATION INFORMATION TO THE
 DIVISION. THE DIVISION SHALL FORWARD APPROPRIATE  REGISTRATION  DATA  TO
 THE LAW ENFORCEMENT AGENCY HAVING LOCAL JURISDICTION OF THE NEW PLACE OF
 RESIDENCE OR LOCATION.
  (C) FOR PURPOSES OF THIS SUBDIVISION:
  (I) "TRANSIENT" SHALL MEAN A PERSON WHO HAS NO RESIDENCE.
  (II)  "RESIDENCE"  SHALL  MEAN ONE OR MORE ADDRESSES AT WHICH A PERSON
