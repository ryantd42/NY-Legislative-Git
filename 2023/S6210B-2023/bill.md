...
S T A T E  O F  N E W  Y O R K
 ...
 by paragraphs (u-1) [and], (v-1), AND (DD) of this  subdivision  in  the
 ...
 (v-1), AND (DD) of this subdivision available to the public  by  posting
 ...
 adding two new paragraphs (dd) and (ee) to read as follows:
  (DD)  PREPARE  FORMS AND COMPILE AND PUBLISH DATA ON EVICTION FILINGS,
 PROCEEDINGS OR ACTIONS IN  ALL  COURTS  IN  THE  UNIFIED  COURT  SYSTEM,
 ...
 EVICTION WAS ISSUED OR STAYED; AND
  (V) IN THE CASE OF DISMISSAL, THE REASONS THEREFOR.
  (EE)  IN ADDITION TO THE DATA REPORTING REQUIRED UNDER PARAGRAPHS (E),
 (U-1), (V-1), (W-1), AND (DD) OF THIS SUBDIVISION,  WHEREVER  THE  CHIEF
